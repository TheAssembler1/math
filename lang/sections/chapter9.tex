...
\begin{proof}
    Let $(x, y) = P$. The center of the reflected circle is $(-x, -y)$.
    Let $(a, b) = X$ be a point lying on the circle $S(r, P)$.
    The reflection through the point $O$ is equivalent 
        to a translation of $(-a, -b)$.
    

    Let $(x, y) = P$. The center of the reflected disc is $(-x, -y)$.
\end{proof}
