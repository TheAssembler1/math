...
\title{A First Course in Real Analysis by Berberian}
\author{Frosty}
\begin{document}
\maketitle
...
\section{Axioms for the field $\mathbb{R}$ of Real Numbers}
\input{sections/chapter1.tex}
\section{First Properties of $\mathbb{R}$}
\input{sections/chapter2.tex}
\section{Sequences of Real Numbers, Convergence}
