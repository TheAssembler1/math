...
\begin{tcolorbox}[title=Problem 6, breakable]
    ...
    \[\pi_1^{-1}(a : b : c) = \{((a : b : c), (x_0 : y_0 : c_0)) \in \sum\}.\]
    Show that hte set $\pi_2(\pi_1^{-1}(a : b : c))$ is identical to a set in $\mathbb{P}^2$
    that we defined near the beggining of this section.
\end{tcolorbox}

\begin{tcolorbox}[title=Problem 7, breakable]
    Given a point $(x_0 : y_0 : z_0) \in \mathbb{P}^2$, consider the set 
    \[\pi_2^{-1}(x_0 : y_0 : z_0) = \{((a : b : c), (x_0 : y_0 : z_0)) \in \sum\}.\]
...
\begin{tcolorbox}[title=Problem 12, breakable]
    ...
    Define 
    \[\mathbb{P}^3 = \mathbb{C}^4 - \{(0, 0, 0, 0)\} \setminus \tilde.\]
...
\begin{tcolorbox}[title=Problem 13, breakable]
    ...
    \[T_p(C) = \{(x : y : z) \in \mathbb{P}^2 \mid (x - x_0) \frac{\partial f}{\partial x}(p)\}\]
    \[+ (y - y_0) \frac{\partial f}{\partial y}(p) + (z - z_0) \frac{\partial f}{\partial z}(p) = 0.\]
