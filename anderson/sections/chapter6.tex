...
\begin{proof}
    (\textbf{Base Case}) Let $n = 1$. Let $(a, b), (c, d) \in R \times S$.
    Consider 
    \[(a, b) + (c, d) = (a + c, b + d) = (c + a, d + b) = (c, d) + (a, b)\]
    (\textbf{Induction Step}) Suppose commutativity holds for $n \in \mathbb{N}$.

    Showing commutativity over $+$.
\end{proof}

\begin{proof}
    (\textbf{Base Case}) Let $n = 1$. Let $(a, b), (c, d), (e, f) \in R \times S$.
    Consider 
...
\begin{proof}
    ...
    Showing the existence of an additive inverse.
\end{proof}
...
\begin{proof}
    ...
    Showing the existence of an additive identity.
\end{proof}
...
\begin{proof}
    ...
    Showing associativity over $\cdot$.
\end{proof}
...
\begin{proof}
    ...
    Showing distributivity fromt the left and right.
\end{proof}
