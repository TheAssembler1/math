...
\begin{tcolorbox}[title=Problem 10, breakable]
    Complete the following multiplicaiton table so tthe following 
    will be a group.
    \[
    \begin{array}{c|cccc}
    & a & b & c & d \\ \hline
...
\textbf{Solution: } Both have no nontrivial finite subgroups.
...
\begin{tcolorbox}[title=Problem 16, breakable]
    Let $Z(G)$, the \textbf{center of} $G$, be thset of elements of $G$
